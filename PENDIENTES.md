...
| 3 | **Tres proyectos sin foto** | Bardahl, Grupo CIMSA y Soriana: las únicas imágenes de la presentación eran capturas de pantalla de Google Maps (con barra del navegador y aviso de derechos de autor). Sus tarjetas y fichas ya **no muestran ninguna fotografía**, para no atribuirles obra ajena: aparecen con un recuadro de marca que dice "Fotografía pendiente". En cuanto lleguen las fotos propias, se sustituye. |

...
| 10 | ~~**ThyssenKrupp**~~ **RESUELTO** | El cliente confirmó las dos obras: **Metalúrgica** (P. Ind. Xoxtla, 18,600 m², llave en mano) y **Presta de México** (P. Ind. Ciudad Textil, 1,500 m², ampliación de nave). Ambas publicadas con sus datos y sus fotos. |
| 10b | **Foto de ThyssenKrupp con letrero de Australia** | El archivo `thyssenkrupp.jpg` muestra un edificio cuyo letrero dice **"ThyssenKrupp Industrial Solutions (Australia) Pty Ltd"**. Se publica como portada de thyssenkrupp Metalúrgica por indicación del cliente. **Conviene que la validen**: el letrero es legible y la ficha dice que la obra está en el Parque Industrial Xoxtla, Puebla. |

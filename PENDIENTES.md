...
| 10 | **ThyssenKrupp: faltan los datos de Metalúrgica** | Ya son dos proyectos separados, con las fotos asignadas como indicó el cliente: las aéreas con dron son la obra de **Xoxtla (18,695 m²)** y las de la carpeta "Metalúrgica" son la segunda obra. **Ojo:** la presentación usa la panorámica de Metalúrgica en la diapositiva de Xoxtla; se respetó lo que dijo el cliente, pero conviene que revisen esa diapositiva. Falta superficie, ubicación exacta y alcance de Metalúrgica. |

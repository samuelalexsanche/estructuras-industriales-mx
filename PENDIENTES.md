...
| 9 | **El CV documenta 74 proyectos; el sitio publica 38** | Van 38 publicados. El CV trae la lista completa con cliente, parque industrial, estado, superficie y alcance de cada obra (Mars, Kiekert, Brose, Hitachi, Ventramex, Fernández Editores, Grupo Modelo, Cargill, Warner Lambert, Sealy, Legrand, Firmenich y más). **Decidir con el cliente si se publican todos**: son páginas nuevas con SEO propio por estado y sector, pero la mayoría no tiene fotos. |
| 10 | **ThyssenKrupp: ya son dos proyectos, faltan datos del segundo** | El cliente confirmó que son obras distintas y ya están separadas. **Pero las carpetas no coinciden con los proyectos:** el aéreo que está dentro de "ThyssenKrupp (Metalúrgica)" es exactamente la imagen que la presentación usa para la obra de **Xoxtla, 18,695 m²**. Por eso esa carpeta quedó asignada a Xoxtla y las tomas con dron de la carpeta "Thyssenkrupp" quedaron como la segunda obra. **Confirmar cuál es cuál**, y pedir superficie, ubicación y alcance de la segunda, que no aparece en el CV ni en la presentación. |
